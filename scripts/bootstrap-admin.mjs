...
const permissions = ["administration.manage", "audit.read", "document.read", "document.create", "document.revise", "document.submit", "document.review", "document.review.complete", "document.review.manage", "document.approve", "document.make_effective", "document.retire", "document.distribute", "document.acknowledge", "document.export", "document.delete", "record.read", "record.create", "record.archive", "record.export", "personnel.read", "personnel.manage", "training.read", "training.manage", "quality_event.read", "quality_event.manage", "equipment.read", "equipment.manage", "notification.manage", "report.read", "report.manage", "report.export", "integration.manage"];
