...
import { QualityClosureReauthenticationFailedError, QualityClosureService, QualityClosureValidationError, type QualityClosureEvidence, type QualityClosureStore } from "./closure";
...
const store=():QualityClosureStore=>({loadEvidence:vi.fn(async()=>evidence),recentFailedReauthentications:vi.fn(async()=>0),recordFailedReauthentication:vi.fn(async()=>undefined),commitClosure:vi.fn(async()=>({closureId:"00000000-0000-0000-0000-000000000004",signatureId:"00000000-0000-0000-0000-000000000005"}))});
