...
const context={organizationId:"11111111-1111-1111-1111-111111111111",userId:"22222222-2222-2222-2222-222222222222",permissions:new Set(["lab_test.manage"]),siteIds:new Set<string>(),departmentIds:new Set<string>()} as any;
