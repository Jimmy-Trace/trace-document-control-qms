...
import { listQualityEventStatusReferences, normalizeReferenceLimit } from "../../../../../../lib/integrations/qms-reference";
...
export async function GET(request: Request) {
  try {
    ...
    const qualityEvents = await listQualityEventStatusReferences(context, { limit });
    return NextResponse.json({ apiVersion: "v1", qualityEvents });
  } catch (error) {
