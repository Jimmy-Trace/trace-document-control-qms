...
import { listMaterialLotStatusReferences, normalizeReferenceLimit } from "../../../../../../../lib/integrations/qms-reference";
...
export async function GET(request: Request) {
  try {
    ...
    const lots = await listMaterialLotStatusReferences(context, { limit });
    return NextResponse.json({ apiVersion: "v1", lots });
  } catch (error) {
